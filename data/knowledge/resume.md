...
- +15% YoY sales through a disruptive go-to-market strategy for a drinks FMCG client
...
- 200M+ organic media impressions — sold out in record time
- Circle of Champions & President's Outliers Award for innovation leadership
...
- Bachelor of Engineering in Information and Communications Technology — Tecnológico de Monterrey
- Leadership Diploma — Tecnológico de Monterrey
- Project Management Professional (PMP) — Project Management Institute (Oct 2016)
- Certified Scrum Product Owner (CSPO) — Scrum Alliance (Oct 2022)
- Strategic Marketing — Kellogg School of Management (Aug 2023)
- Marketing Data Analysis — Wharton Executive Education (Aug 2022)

## Awards

- President's Outliers Award — PepsiCo, for the Doritos Rainbow initiative
- Circle of Champions — PepsiCo, top 0.1% worldwide
- James E. Burke Award — Johnson & Johnson, Creative Leadership

## Tools & platforms

Nielsen, Euromonitor, Google Analytics, Google Ads, Meta Business Suite, SEMrush, HubSpot, Tableau, Shopify, Kantar, Power BI, Microsoft Office Suite.

## Career-defining impact metrics

- apex Consulting: +15% YoY sales growth via disruptive GTM strategy and portfolio repositioning for a drinks FMCG client in Mexico
- apex Consulting: -35% drop-off reduction via consumer research driving UX improvements for a US telecom client's support funnel
- apex Consulting: -20% CPC reduction via A/B testing across paid social channels for a FinTech client's acquisition campaigns
- Grupo Mariposa: +35% revenue growth — built and scaled a digital-first export brand from zero with full P&L ownership
- Johnson & Johnson: +11% YoY B2B revenue via innovation launches and shopper marketing programs across Mexico, Central America, and the Andean region
- PepsiCo: +2.3% brand SOM (share of market) growth — Doritos Rainbow generated 200M+ impressions and sold out in record time
