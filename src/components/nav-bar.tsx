          ...
          <div className="flex items-center px-8 py-3 max-w-[1920px] mx-auto gap-8">
            ...
            <div className="hidden md:flex flex-1 justify-center items-center gap-10">
              {links.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className={`relative font-label tracking-tight text-sm uppercase font-semibold transition-all duration-300 after:content-[''] after:absolute after:left-0 after:-bottom-[5px] after:w-full after:h-px after:bg-accent after:origin-left after:transition-transform after:duration-300 after:ease-[cubic-bezier(0.22,1,0.36,1)] hover:after:scale-x-100 ${
                    activeSection === link.section
                      ? "text-accent opacity-100 after:scale-x-100"
                      : "text-ink opacity-70 hover:opacity-100 hover:text-accent after:scale-x-0"
                  }`}
                >
                  {link.label}
                </a>
            ...
            <div className="ml-auto flex items-center gap-3">
              ...
              <button
                ...
                className="w-[34px] h-[34px] rounded-full border border-ink/20 hover:border-accent text-ink/70 hover:text-accent flex items-center justify-center flex-shrink-0 transition-colors duration-200"
              >
                {isDark ? (
